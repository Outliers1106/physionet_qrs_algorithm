...
void sqrs125(int argc, char **argv)
{
    char *p, *record = NULL, *prog_name_sqrs125();
    ...
    pname = prog_name_sqrs125(argv[0]);
    ...
    a.name = "125sqrs"; a.stat = WFDB_WRITE;
	//2019.10.27
